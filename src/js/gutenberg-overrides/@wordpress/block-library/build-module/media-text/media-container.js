...
class MediaContainer extends Component {
  ...
  renderImage () {
    const { mediaAlt, mediaUrl, className, mediaData } = this.props;
    return (
      <Fragment>
        { this.renderToolbarEditButton() }
        <figure className={ className }>
          <img src={ mediaUrl } alt={ mediaAlt } { ...mediaData } />
        </figure>
      </Fragment>
    );
  }
  ...
  renderVideo () {
    const { mediaUrl, className, mediaData } = this.props;
    return (
      <Fragment>
        { this.renderToolbarEditButton() }
        <figure className={ className }>
          <video controls src={ mediaUrl } { ...mediaData } />
        </figure>
      </Fragment>
    );
  }
