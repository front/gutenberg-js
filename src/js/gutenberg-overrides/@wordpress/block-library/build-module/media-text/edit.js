...
class MediaTextEdit extends Component {
  ...
  onSelectMedia (media) {
    ...
    if (media.data) {
      toUpdate.mediaData = Object.keys(media.data)
      .reduce((result, key) => {
  ...
  renderMediaArea () {
    ...
    const { mediaAlt, mediaId, mediaPosition, mediaType, mediaUrl, mediaWidth, mediaData } = attributes;
    ...
    return (
      <MediaContainer
        ...
        { ...{ mediaAlt, mediaId, mediaType, mediaUrl, mediaPosition, mediaWidth, mediaData } }
      />
    );
  }
